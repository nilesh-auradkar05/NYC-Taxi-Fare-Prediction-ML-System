...
The inference pipeline follows the same architecture as the training pipeline, using Metaflow for
orchestration and MLflow for model management.
...
class Inference(Pipeline):
    ...
    def start(self):
        ...
        try:
            ...
            # This will automatically handle the deserialization of the XGBoost model
    ...
    def feature_engineering(self):
        ...
        # formula used: sin(value * 2 * pi / period) and cos(value * 2 * pi / period)
        ...
        # These must match exactly what was used during training phase.
